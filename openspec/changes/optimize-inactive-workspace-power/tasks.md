...
- [ ] 5.2 Add tests showing hidden-session title, progress, bell, clipboard/effects callbacks, and child lifecycle events still flow through existing terminal action handling where test infrastructure supports them.
